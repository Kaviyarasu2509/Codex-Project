          ...
          <div className="nb-nav-inner">
            ...
            <ul className="nb-links">
              ...
              <li>
                ...
                >
                  <i className="fa-solid fa-house nb-link-icon" aria-hidden="true"></i>
                  Home
              ...
              <li className="nb-dropdown-wrap" ref={aboutDropRef}>
                ...
                >
                  <i className="fa-solid fa-building nb-link-icon" aria-hidden="true"></i>
                  About
                  <i className={`fa-solid fa-chevron-down nb-chevron ${aboutOpen ? "nb-chevron-open" : ""}`} aria-hidden="true"></i>
                    ...
                    {aboutLinks.map((a) => (
                      ...
                      >
                        ...
                        {location.pathname === a.to && (
                          <i className="fa-solid fa-check nb-di-check" aria-hidden="true"></i>
                        )}
                      </Link>
                    ))}
                  </div>
              ...
              <li className="nb-dropdown-wrap" ref={serviceDropRef}>
                ...
                >
                  <i className="fa-solid fa-layer-group nb-link-icon" aria-hidden="true"></i>
                  Services
                  <i className={`fa-solid fa-chevron-down nb-chevron ${serviceOpen ? "nb-chevron-open" : ""}`} aria-hidden="true"></i>
              ...
              {navLinks.slice(1).map((lk) => (
                <li key={lk.to}>
                  ...
                  >
                    <i className={`fa-solid ${lk.icon} nb-link-icon`} aria-hidden="true"></i>
                    {lk.label}
        ...
        <div className="nb-mobile-inner">
          ...
          <div className="nb-mobile-contact">
            <a href="tel:+918525999002" className="nb-mc-item">
              <i className="fa-solid fa-phone" aria-hidden="true"></i> 85259 99002
            </a>
            <a href="tel:+918525999022" className="nb-mc-item">
              <i className="fa-solid fa-laptop-code" aria-hidden="true"></i> 85259 99022
            </a>
          </div>
          ...
          <ul className="nb-mobile-links">
            ...
            <li>
              <Link to="/" className={`nb-ml-item ${location.pathname === "/" ? "nb-ml-active" : ""}`}>
                ...
                Home
                {location.pathname === "/" && <i className="fa-solid fa-circle-dot nb-ml-dot" aria-hidden="true"></i>}
              </Link>
            </li>
            ...
            <li>
              ...
              >
                ...
                About
                <i className={`fa-solid fa-chevron-down nb-ml-chev ${mobileAboutOpen ? "nb-ml-chev-open" : ""}`} aria-hidden="true"></i>
              </button>
            ...
            <li>
              ...
              >
                ...
                Services
                <i className={`fa-solid fa-chevron-down nb-ml-chev ${mobileServiceOpen ? "nb-ml-chev-open" : ""}`} aria-hidden="true"></i>
              </button>
            ...
            {navLinks.slice(1).map((lk) => (
              <li key={lk.to}>
                ...
                >
                  <i className={`fa-solid ${lk.icon}`} aria-hidden="true"></i>
                  {lk.label}
                  {isActive(lk.to) && <i className="fa-solid fa-circle-dot nb-ml-dot" aria-hidden="true"></i>}
                </Link>
              </li>
            ))}
